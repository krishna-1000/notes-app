...
const DropDown = () => {
    return (
        <div className='z-50 absolute flex hover:cursor-pointer flex-col gap-1 top-10 left-37 w-45 rounded-sm h-65 pt-4 bg-[#26313f] border border-gray-400 shadow-lg '>

            <Link to={'/rich-text-editor'}>
