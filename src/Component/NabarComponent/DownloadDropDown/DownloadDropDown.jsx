...
const DownloadDropDown = () => {
    const {notes} = useNote();
  return (
            <div className='absolute flex hover:cursor-pointer flex-col gap-1 top-10 left-56 w-45 h-fit rounded-sm h-30 pt-4 bg-[#26313f] border border-gray-400 shadow-lg z-10'>
